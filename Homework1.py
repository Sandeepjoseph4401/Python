#Program to perform search operation on a dataset
...
while(userchoice.lower() == 'yes'):
    ...
    #perform and search                          
        ...
        Wlen = len(query)
        print("\nAND search as per user request on querry: "+str(query)+".......")
...
OR search as per user request on querry: ['flower', 'sheep'].......
...
AND search as per user request on querry: ['flower', 'sheep'].......
...
Please enter your search querry : sheep and flower or star

AND search as per user request on querry: ['flower', 'sheep', 'star'].......
